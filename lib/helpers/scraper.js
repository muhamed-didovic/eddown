            ...
            if (isHtml) {
                ...
                if (svg) {
                    ...
                    const svgs = await page.evaluate(async () => {
                        ...
                        let srcs = []
                        iFrame.forEach((myObject) => {

                            // Check if the object element and its contentDocument exist
                            /*if (objectEl && objectEl.contentDocument) {
                                // Get the SVG element inside the contentDocument
                                const svgEl = objectEl.contentDocument.querySelector('svg');

                                // Check if the SVG element exists
                                if (svgEl) {
                                    // Check if the SVG element is an image or not
                                    const isImage = svgEl.nodeName.toLowerCase() === 'image';

                                    // Do something with the SVG element
                                    console.log('SVG element found:', svgEl);

                                    // Do something with the isImage value
                                    console.log('Is SVG an image?', isImage);
                                } else {
                                    console.log('SVG element not found');
                                }
                            } else {
                                console.log('Object element or contentDocument not found');
                            }*/
                            ...
                            if (svgImage && svgImage.getAttribute('xlink:href')) {
