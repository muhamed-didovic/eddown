...
(async () => {
    ...
    console.log('error 1:',path.resolve(__dirname, '/../errors'));
    console.log('error 2:',path.resolve(__dirname, '../errors'));
    console.log('error 3:',path.join(__dirname, '/../errors'));
    console.log('error 4:',path.join(__dirname, '../errors'));
