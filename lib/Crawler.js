            ...
            return await this.withPage(browser)(async (page) => {
                ...
                const lessons = await Promise
                    .mapSeries(courses, async course => {
                        ...
                        /*let lessons = [
                            {
                                "series"  : "An Introduction to Microservice Principles and Concepts",
                                "title"   : "03-Introduction.mp4",
                                "position": 3,
                                "downPath": "An Introduction to Microservice Principles and Concepts",
                                "url"     : "https://www.educative.io/courses/introduction-microservice-principles-concepts/N7Y2ZzKNl1p"
                            }]*/
                        /*let lessons = [
                            {
